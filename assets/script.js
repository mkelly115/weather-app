    ...
    fetch(cityUrl)
        ...
        .then(function (fiveDay) {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                // const date = GONNA NEED DAY.JS FOR THIS
                ...
                displayFiveDay(fiveDayHumidities, fiveDayWindSpeeds, fiveDayIcons, fiveDayTemps)
            }
        })
...
function displayFiveDay(fiveDayHumidities, fiveDayWindSpeeds, fiveDayIcons, fiveDayTemps) {
